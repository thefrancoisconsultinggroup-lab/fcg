...
type ThriveWeeklyHeroProps = {
  targetId?: string;
};

export function ThriveWeeklyHero({ targetId = "thrive-weekly-body" }: ThriveWeeklyHeroProps) {
  return (
    <section className="relative isolate overflow-hidden text-foreground" data-thrive-weekly-hero>
      <div className="absolute inset-0 -z-20" data-thrive-weekly-hero-media>
        <HeroBackgroundVideo
      ...
      <div
        ...
        data-thrive-weekly-hero-overlay
      />
      ...
      <Container className="relative z-10 flex min-h-screen min-h-[100svh] min-h-[100dvh] flex-col justify-center pt-28 pb-28 sm:pt-32 sm:pb-32 lg:pt-36 lg:pb-36">
        <div className="max-w-5xl pt-12 sm:pt-14 lg:pt-18" data-thrive-weekly-hero-content>
