...
export type SummitCorporatePackageValue =
  ...
  | "corporate-10"
  | "corporate-20";
export type SummitRateValue = SummitIndividualRateValue | SummitCorporatePackageValue;
...
export const summitCorporatePackages = [
  ...
  {
    value: "corporate-10",
    label: "Standard Corporate Group of up to 10",
    detail: "Ends October 1, 2026",
    capacity: 10,
    endsOn: "2026-10-01",
  ...
  {
    value: "corporate-20",
    label: "Standard Corporate Group of up to 20",
    detail: "Ends October 1, 2026",
    capacity: 20,
    endsOn: "2026-10-01",
    originalPrice: undefined,
